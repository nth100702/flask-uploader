...
class FileUpload(db.Model):
    ...
    upload_completed = db.Column(db.Boolean, default=False) # to onedrive
    # timestamp, tz = gmt+7 (vietnam)
    created_at = db.Column(db.DateTime, nullable=False, default=now()) # server received
    uploaded_at = db.Column(db.DateTime, nullable=False, default=now()) # server uploaded the file to oneDrive
